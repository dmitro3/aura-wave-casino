-- Manual Roulette Statistics Fix
-- Run this directly in Supabase SQL Editor

-- First, add the missing columns if they don't exist
DO $$ 
BEGIN
    -- Add new roulette statistics columns
...
-- Now create/update the enhanced stats function
...
BEGIN
  ...
  RAISE NOTICE 'update_user_stats_and_level called: user=%, game=%, bet=%, result=%, profit=%', p_user_id, p_game_type, p_bet_amount, p_result, p_profit;
  ...
  RAISE NOTICE 'XP calculation: old=%, bet=%, new=%', current_stats.lifetime_xp, p_bet_amount::INTEGER, new_xp;
...
SELECT 'Roulette stats function updated successfully! You can now run this in Supabase SQL Editor.' as status;