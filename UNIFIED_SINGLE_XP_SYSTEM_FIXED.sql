-- UNIFIED SINGLE XP SYSTEM - FIXED VERSION
-- This creates a clean, unified XP system with one total XP value per user
-- Fixes the recursive CTE type mismatch error
...
SET 
  ...
  xp = GREATEST(COALESCE(p.lifetime_xp, 0), COALESCE(p.current_xp, 0), COALESCE(p.xp, 0))
