-- Fix Roulette XP Calculation - Award 10% of wager as XP and recalculate levels properly
-- Issue: Currently giving 1 XP per dollar, should be 0.1 XP per dollar (10% of wager)
