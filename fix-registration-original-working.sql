-- RESTORE ORIGINAL WORKING SETUP - RUN THIS DIRECTLY ON PRODUCTION DATABASE
-- This script restores the original working RLS setup that allowed registration to work
