	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'glow-pulse': {
					'0%, 100%': {
						boxShadow: '0 0 10px hsl(var(--primary-glow) / 0.3)'
					},
					'50%': {
						boxShadow: '0 0 20px hsl(var(--primary-glow) / 0.6), 0 0 30px hsl(var(--primary-glow) / 0.4)'
					}
				},
				'new-item': {
					'0%': {
			...
			animation: {
				...
				'new-item': 'new-item 0.6s ease-out',
