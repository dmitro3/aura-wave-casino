-- SAFE XP SYSTEM FIX - Corrected Version
-- This is safe to run and won't break anything
-- Run this in Supabase Dashboard SQL Editor

-- ==================================================
-- STEP 1: SAFELY DROP AND RECREATE FUNCTIONS
-- ==================================================

-- Drop triggers and functions safely
...
-- Ensure profiles.lifetime_xp supports 3 decimals
...
-- ==================================================
-- STEP 3: CREATE SAFE ADD XP FUNCTION
-- ==================================================
...
-- ==================================================
-- STEP 4: CREATE SAFE TRIGGER FUNCTION
-- ==================================================
...
BEGIN
  ...
  -- Calculate XP using correct formula: bet_amount / 10
...
-- ==================================================
-- STEP 6: SAFE VERIFICATION TESTS
-- ==================================================

-- Test the XP calculation function
SELECT 
  'XP CALCULATION TEST' as test_name,
  'Expected: $1=0.100, $0.01=0.001, $10=1.000' as description;

SELECT 
  public.calculate_xp_from_bet(0.01) as cent_test,
  public.calculate_xp_from_bet(1.00) as dollar_test,
  public.calculate_xp_from_bet(10.00) as ten_dollar_test;

-- Check table structure
SELECT 
  'profiles.lifetime_xp structure:' as description,
  data_type,
  numeric_precision,
  numeric_scale
...
SELECT 
  ...
  'XP system rebuilt safely with correct /10 formula' as message;