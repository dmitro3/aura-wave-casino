-- FIX 406 ERRORS - RUN THIS DIRECTLY ON PRODUCTION DATABASE
-- This script fixes the RLS policies that are causing 406 errors for user_level_stats and admin_users
