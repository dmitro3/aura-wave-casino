-- Fix Complete Roulette Round Function - Remove add_xp_from_wager dependency
-- The function in database is calling missing add_xp_from_wager function

BEGIN;

-- =====================================================================
-- REPLACE COMPLETE_ROULETTE_ROUND WITH WORKING VERSION
-- =====================================================================

-- Drop the broken version that calls add_xp_from_wager
DROP FUNCTION IF EXISTS public.complete_roulette_round(UUID) CASCADE;

-- Create the correct working version (same as fix_roulette_xp_calculation_corrected.sql)
...
-- ISSUE RESOLVED
-- =====================================================================
-- ✅ Removed dependency on missing add_xp_from_wager function
-- ✅ XP calculation now handled directly in function (10% of wager)
-- ✅ Level recalculation using exact XP functions
...
SELECT 
  ...
  'complete_roulette_round function recreated successfully' as status;