-- Fix UI XP display and RLS security warning
...
-- Refresh materialized views and stats if any exist
REFRESH MATERIALIZED VIEW IF EXISTS public.user_stats_summary;
