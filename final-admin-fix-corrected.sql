-- Final Admin Access Fix - CORRECTED VERSION
...
-- Step 7: Create the correct policies (separate policies for each operation)

-- Allow everyone to read admin status (for badges)
...
-- Success! You should see your admin record returned.
-- Refresh your website and the admin button should appear only for you.