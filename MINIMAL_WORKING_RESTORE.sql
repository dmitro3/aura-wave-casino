-- MINIMAL WORKING DATABASE RESTORE
-- This script uses the simplest possible syntax to avoid all errors
...
DO $$
BEGIN
    RAISE NOTICE 'Minimal working database restore finished successfully!';
