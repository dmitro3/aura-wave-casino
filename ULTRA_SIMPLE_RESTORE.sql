-- ULTRA SIMPLE DATABASE RESTORE
-- This script creates functions one by one to avoid syntax errors
...
DO $$
BEGIN
    RAISE NOTICE 'Ultra simple database restore finished successfully!';
