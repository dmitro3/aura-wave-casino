-- ===============================================
-- FIX STATISTICS TRACKING AFTER PERFORMANCE MIGRATION
-- ===============================================
-- This fixes the issues caused by the performance optimization migration
-- Run this in Supabase SQL Editor to restore statistics tracking
...
-- Drop and recreate missing critical policies for statistics tracking
...
BEGIN
  ...
  RAISE NOTICE '✅ Statistics tracking function is working properly';
EXCEPTION WHEN OTHERS THEN
  RAISE NOTICE '❌ Statistics tracking test failed: %', SQLERRM;
END;
$$;

-- Final success message
RAISE NOTICE '🎯 Statistics tracking permissions have been restored!';
RAISE NOTICE '📊 All game engines should now properly track stats and XP';
RAISE NOTICE '🔧 Edge Functions have service_role access to all required tables';
RAISE NOTICE '🎲 Roulette, Tower, and Coinflip games can now process bets and update stats';
RAISE NOTICE '🛡️ Function overloading issues have been resolved';