-- Migration: Add missing stat tracking to existing update_user_level_stats function
-- This enhances the existing function to track advanced stats like biggest_single_bet, biggest_win, etc.
