-- Fix all issues properly with cascade:
...
-- 2. Now drop the functions with cascade
DROP FUNCTION IF EXISTS public.add_coinflip_to_live_feed() CASCADE;
DROP FUNCTION IF EXISTS public.trigger_add_to_live_feed() CASCADE;

-- 3. Create SINGLE NEW trigger function that handles all games properly
