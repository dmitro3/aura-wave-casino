...
-- This migration completely disables RLS and ensures registration works
...
ALTER TABLE public.unlocked_achievements DISABLE ROW LEVEL SECURITY;
ALTER TABLE public.user_achievements DISABLE ROW LEVEL SECURITY;
ALTER TABLE public.user_daily_logins DISABLE ROW LEVEL SECURITY;
ALTER TABLE public.user_rate_limits DISABLE ROW LEVEL SECURITY;
ALTER TABLE public.level_daily_cases DISABLE ROW LEVEL SECURITY;
ALTER TABLE public.level_rewards DISABLE ROW LEVEL SECURITY;
ALTER TABLE public.live_bet_feed DISABLE ROW LEVEL SECURITY;
ALTER TABLE public.maintenance_settings DISABLE ROW LEVEL SECURITY;
ALTER TABLE public.pending_account_deletions DISABLE ROW LEVEL SECURITY;
...
ALTER TABLE public.crash_bets DISABLE ROW LEVEL SECURITY;
ALTER TABLE public.crash_rounds DISABLE ROW LEVEL SECURITY;
ALTER TABLE public.tower_games DISABLE ROW LEVEL SECURITY;
ALTER TABLE public.tower_levels DISABLE ROW LEVEL SECURITY;
ALTER TABLE public.daily_seeds DISABLE ROW LEVEL SECURITY;
ALTER TABLE public.free_case_claims DISABLE ROW LEVEL SECURITY;
ALTER TABLE public.border_tiers DISABLE ROW LEVEL SECURITY;
