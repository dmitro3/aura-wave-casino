-- 🔧 FIX RAISE NOTICE PARAMETER ERRORS
-- Fix the RAISE NOTICE statements causing "too few parameters" error

BEGIN;

DO $$ BEGIN RAISE NOTICE '🔧 Fixing RAISE NOTICE parameter errors...'; END $$;
...
-- 7. Test the corrected XP calculation with FIXED RAISE NOTICE statements
DO $$
DECLARE
  test_user_id uuid;
  test_result RECORD;
