-- Fresh user registration system based on exact database schema
-- This completely replaces the existing system with a working version

-- Step 1: Drop existing trigger and function
DROP TRIGGER IF EXISTS on_auth_user_created ON auth.users;
DROP FUNCTION IF EXISTS public.handle_new_user();

-- Step 2: Ensure foreign key constraint is correct
...
-- Step 3: Create a minimal, working handle_new_user function
...
BEGIN
  ...
  -- Insert into profiles (minimal required fields)
  ...
  -- Insert into user_level_stats (minimal required fields)
...
DO $$
BEGIN
  RAISE NOTICE '✅ User registration system created successfully';
END $$;
