-- ===============================================
-- FIXED COMPLETE XP/LEVEL/STATS SYSTEM REBUILD
-- ===============================================
...
BEGIN
    ...
    -- Calculate new level using the correct function name
...
DO $$
BEGIN
    RAISE NOTICE '🧪 Testing FIXED XP/Stats system:';
    ...
    RAISE NOTICE '✅ FIXED complete stats system rebuilt successfully!';
    ...
    RAISE NOTICE '🔧 Using correct calculate_level_from_xp_new function';
END $$;