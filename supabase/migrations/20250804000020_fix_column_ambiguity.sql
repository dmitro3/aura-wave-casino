...
DO $$ BEGIN RAISE NOTICE '🔧 Fixing column ambiguity in level calculation function...'; END $$;
...
BEGIN
  ...
  RAISE NOTICE 'Test 6849 XP: Level %, Current %, To Next %', test_result.user_level, test_result.current_level_xp, test_result.xp_to_next;
...
DO $$ BEGIN RAISE NOTICE '✅ Level calculation fixed with proper column references'; END $$;
