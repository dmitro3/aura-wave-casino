-- Update level daily cases functions to use user_level_stats table instead of profiles.level
-- This migration fixes the "Failed to load level daily cases" error

-- Update the get_user_level_daily_cases function
...
-- Update the open_level_daily_case function
...
-- Update any other functions that might reference profiles.level
-- Check if initialize_level_daily_cases function needs updating
